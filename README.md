...
***Workflow examples***
- Moving from DAGS to data: "DAGstoData.R" simulates synthetic data for 30 different countries based on the DAG in Fig.2b and performs a power analysis varing the amount of unexplained variation and the effect size.
